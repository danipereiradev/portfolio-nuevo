  ...
  content: (
    <>
      <p>
        ...
        (WordPress, Shopify) o un framework (React, Next.js, Vue). No hay una
        pila correcta para todos los casos. Hay una que encaja con lo que la web
        tiene que hacer.
      </p>
      <BlogFigure
        src='/img/portfolio/mock-carper.png'
      ...
      <p>
        ...
        contratar un <a href={SITE_WEB_PATH}>diseño web a medida</a>: lenguajes
        de programación, librerías, frameworks y CMS. Sin moda de turno. Con
      ...
      <p>
        ...
        HTML, CSS y JavaScript. El resto son herramientas para producir eso más
        rápido, con panel de edición o con más control.
      </p>
      <ul>
        <li>
        ...
        <li>
          <strong>CSS.</strong> El aspecto: tipografía, color, móvil, layout.
          Una web que no se lee en el teléfono suele pecar aquí.
        </li>
        <li>
          <strong>JavaScript.</strong> Lo que se mueve en el navegador: menús,
          formularios, carritos, filtros. Casi todas las webs modernas lo usan.
        </li>
        <li>
          <strong>TypeScript.</strong> JavaScript con tipos. En PereiraWeb lo
          usamos en desarrollos a medida: menos errores, más claro qué hace cada
          pieza.
        </li>
        <li>
          <strong>PHP.</strong> El lenguaje de WordPress. El servidor monta la
          página y te deja un panel para textos y fotos.
        </li>
      </ul>
      <p>
        Python, Ruby o Go también sirven para la parte de servidor. En webs de
        negocio en España lo habitual es PHP (WordPress) o JavaScript /
        TypeScript (a medida).
      </p>

      <h2>Librerías de JavaScript</h2>
      <p>
        Una librería es un trozo de código que resuelve una cosa. No te impone
        cómo montar toda la web. Ejemplos que siguen saliendo: jQuery (cada vez
        menos), Swiper para carruseles, librerías de fechas o de mapas.
      </p>
      <BlogFigure
      ...
      />
      <p>
        <strong>React</strong> es una librería para construir interfaces. Se usa
        tanto que mucha gente la llama framework. Encima de React suelen ir
        frameworks de verdad: Next.js, Remix, Astro con React. Vue y Svelte
        cubren un territorio parecido.
      </p>
      <p>
        En una web de empresa no hace falta “la librería de moda”. Hace falta
        que cargue, que se edite si toca y que no se rompa en el móvil.
      </p>

      <h2>Frameworks para desarrollo web</h2>
      <p>
        Un framework es un armazón: te dice cómo organizar rutas, componentes y
        datos. Acelera un desarrollo a medida. También te ata a sus reglas.
      </p>
      <ul>
        <li>
          <strong>React + Vite.</strong> Webs a medida rápidas de publicar.
          Encaja cuando el diseño es propio y el contenido no cambia cada día.
        </li>
        <li>
          <strong>Next.js.</strong> Framework sobre React. Útil si hace falta
          SEO fino, varias páginas y algo de servidor. No es obligatorio “porque
          está de moda”.
        </li>
        <li>
          <strong>Vue o Angular.</strong> Otras formas de montar la interfaz.
          Angular suele ir a proyectos grandes de empresa. Vue, a equipos que lo
          dominan.
        </li>
        <li>
          <strong>Astro o Svelte.</strong> Sitios que tienen que pesar poco.
          Bien para contenido que se lee, no para un panel enorme.
        </li>
      </ul>
      <p>
        Un framework no sustituye el diseño web. Monta la página. El criterio de
        qué usar lo pone el caso, no el catálogo de tecnologías.
      </p>

      <h2>CMS para crear una página web</h2>
      <p>
        Un CMS (Content Management System) es un panel para que edites textos,
        fotos y páginas sin tocar código. Es la opción de mucha pyme y autónomo
        que quiere cambiar un párrafo un martes.
      </p>
      <ul>
        <li>
          <strong>WordPress.</strong> El CMS más usado del mundo. Plugins,
          plantillas y, bien montado, una web seria. Mal montado, lenta y llena
          de parches. El problema no es WordPress: es usarlo como cajón de
          sastre.
        </li>
        <li>
          <strong>WooCommerce.</strong> WordPress para vender. Catálogo, pagos y
          pedidos. Encaja en muchas <a href={SITE_SHOP_PATH}>tiendas online</a>{' '}
          de tamaño medio.
        </li>
        <li>
          <strong>Shopify.</strong> CMS de ecommerce alojado. Panel sencillo y
          apps. Menos control de la base; más rapidez para abrir tienda.
        </li>
        <li>
          <strong>Webflow u otros builders.</strong> Sirven para prototipos o
          sitios muy visuales. Para un negocio que tiene que durar años, suele
          pesar más el hosting, el SEO y quién la mantiene.
        </li>
      </ul>
      <p>
        Headless CMS (un panel por un lado, la web por otro) tiene sentido
        cuando hay varios canales o un equipo de contenido grande. En una web de
        servicios de 8 páginas, casi nunca.
      </p>

      <h2>WordPress, framework o desarrollo a medida</h2>
      <p>
        La pregunta útil no es “¿cuál es mejor tecnología para crear una página
        web?”. Es “¿qué tiene que hacer esta?”.
      </p>
      <div className='overflow-hidden rounded-lg border-2 border-ink-dark'>
        <table>
          <thead>
      ...
      <p>
        En PereiraWeb no hay un stack único. WordPress si encaja. A medida si el
        caso lo pide. Te lo decimos en la propuesta, sin venderte lo más caro
        por sistema. El{' '}
        <a href='/blog/cuanto-cuesta-una-pagina-web-profesional'>
          precio de una página web profesional en 2026
        </a>{' '}
      ...
      <p>
        Agencia de diseño web y marketing digital en Madrid. En webs de negocio
      ...
      <p>
        Tailwind, librerías de sliders o un CMS headless entran si aportan. No
        si solo quedan bien en una ficha técnica.
      </p>

      <h2>Cómo elegir tecnologías para tu página web</h2>
      <p>
        Empieza por el uso: ¿consultas, ventas, marca, blog? Luego el
        mantenimiento: ¿la vas a editar tú cada semana? Luego el presupuesto y
        el plazo. La tecnología es la consecuencia.
      </p>
      <p>
        Si alguien te vende “solo React” o “solo WordPress” antes de preguntarte
        qué tiene que hacer la página, está vendiendo su herramienta, no tu web.
        En 24–48 h laborables te decimos qué entra, con qué se monta y cuánto
        sale. Por escrito.
      </p>
    </>
  ),
