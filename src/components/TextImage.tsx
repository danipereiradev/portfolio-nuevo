...
export const TextImage = ({ label, title, paragraphs }: TextImageProps) => {
  return (
    <section className='mx-auto flex flex-col-reverse md:flex-row-reverse items-center md:h-[100vh] text-center md:text-start gap-8 py-24 px-4 md:py-0 md:px-8'>
