    ...
    >
      ...
      <div className='relative z-10 text-center px-6 max-w-4xl mx-auto'>
        ...
        <div className='flex flex-wrap gap-3 justify-center mb-8'>
          ...
          <span className='bg-yellow-400 text-gray-900 px-4 py-2 rounded-full text-sm font-bold shadow-lg flex items-center gap-2'>
            <svg className='w-4 h-4' fill='currentColor' viewBox='0 0 20 20'>
          ...
          <span className='bg-purple-500 text-white px-4 py-2 rounded-full text-sm font-bold shadow-lg flex items-center gap-2'>
            <svg className='w-4 h-4' fill='currentColor' viewBox='0 0 20 20'>
              <path d='M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z' />
            </svg>
            4.8/5 valoración
          </span>
          <span className='bg-white/20 backdrop-blur-sm text-white px-4 py-2 rounded-full text-sm font-bold shadow-lg flex items-center gap-2 border border-white/30'>
            <svg className='w-4 h-4' fill='currentColor' viewBox='0 0 20 20'>
              <path
                fillRule='evenodd'
