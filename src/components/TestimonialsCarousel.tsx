      ...
      <div className='container mx-auto px-6'>
        ...
        <div className='max-w-4xl mx-auto relative'>
          ...
          <div className='bg-gradient-to-br from-blue-50 to-cyan-50 rounded-2xl shadow-xl p-8 md:p-12 relative overflow-hidden'>
            ...
            <div className='flex items-center justify-center gap-4'>
              ...
              <div className='text-left'>
                ...
                <p className='text-accent font-medium'>{currentTest.company}</p>
          ...
          <button
            ...
            className='absolute left-0 md:-left-4 top-1/2 -translate-y-1/2 bg-white p-3 rounded-full shadow-lg hover:bg-gray-50 transition-all duration-200 z-10'
          ...
          <button
            ...
            className='absolute right-0 md:-right-4 top-1/2 -translate-y-1/2 bg-white p-3 rounded-full shadow-lg hover:bg-gray-50 transition-all duration-200 z-10'
          ...
          <p className='text-center text-gray-500 text-sm mt-4'>
            {currentTestimonial + 1} de {testimonials.length} testimonios
          </p>
        </div>
      </div>
    </section>
