            ...
            <div className='prose max-w-none'>
              ...
              <section className='mb-8'>
                ...
                <div className='bg-gray-50 p-4 rounded-lg'>
                  <p>
                    <strong>Responsable:</strong> Daniel Pereira Gesteiro
                  </p>
                  <p>
              ...
              <section className='mb-8'>
                ...
                <ul className='list-disc pl-6 space-y-2'>
                  ...
                  <li>
                    <strong>Datos del proyecto:</strong> Tipo de proyecto,
                    presupuesto, plazos, descripción
                  </li>
                  <li>
              ...
              <section className='mb-8'>
                ...
                <ul className='list-disc pl-6 space-y-2'>
                  <li>
                    <strong>Consentimiento:</strong> Para comunicaciones
                    comerciales
                  </li>
                  <li>
                    <strong>Ejecución contractual:</strong> Para prestación de
                    servicios
                  </li>
                  <li>
                    <strong>Interés legítimo:</strong> Para mejora de servicios
                  </li>
                  <li>
                    <strong>Cumplimiento legal:</strong> Para obligaciones
              ...
              <section className='mb-8'>
                ...
                <ul className='list-disc pl-6 space-y-2 mt-4'>
                  ...
                  <li>
                    <strong>Datos contractuales:</strong> Durante la relación
                    comercial + 6 años
                  </li>
                  <li>
                    <strong>Datos fiscales:</strong> 4 años según normativa
                    fiscal
                  </li>
                </ul>
              </section>
              ...
              <section className='mb-8'>
                ...
                <ul className='list-disc pl-6 space-y-2'>
                  ...
                  <li>
                    <strong>Supresión:</strong> Eliminar tus datos
                  </li>
                  <li>
          ...
          <div className='space-y-6'>
            ...
            <div className='prose max-w-none'>
              ...
              <section className='mb-8'>
                ...
                <div className='bg-gray-50 p-4 rounded-lg'>
                  <p>
                    <strong>Titular:</strong> Daniel Pereira Gesteiro
                  </p>
                  <p>
                    <strong>NIF:</strong> 36153235H
                  </p>
              ...
              <section className='mb-8'>
                ...
                <ul className='list-disc pl-6 space-y-2'>
                  <li>
                    El cliente adquiere los derechos de uso del proyecto una vez
              ...
              <section className='mb-8'>
                ...
                <p>
                  Para la resolución de controversias, las partes se someten a
                  los juzgados y tribunales de Madrid, renunciando a cualquier
            ...
            <div className='prose max-w-none'>
              ...
              <section className='mb-8'>
                ...
                <p>
                  ...
                  tu dispositivo cuando visitas un sitio web. Nos ayudan a
              ...
              <section className='mb-8'>
                ...
                <div className='bg-yellow-50 p-4 rounded-lg'>
                  ...
                  <p className='text-sm text-yellow-800'>
                    Deshabilitar las cookies técnicas puede afectar al
                    funcionamiento correcto del sitio web.
                  </p>
                </div>
              </section>
            ...
            <div className='prose max-w-none'>
              ...
              <section className='mb-8'>
                ...
                <p className='mt-4'>
                  ...
                  usuario del mismo e implica la aceptación plena y sin reservas
                  de todas y cada una de las disposiciones incluidas en este
                  aviso legal.
                </p>
              </section>
              ...
              <section className='mb-8'>
                ...
                <ul className='list-disc pl-6 space-y-2'>
                  ...
                  <li>
                    Queda prohibido el uso del sitio web para fines ilícitos o
                    lesivos
                  </li>
                  <li>
                    No se permite la reproducción, distribución o modificación
                    de los contenidos sin autorización
                  </li>
                </ul>
              </section>
              ...
              <section className='mb-8'>
                ...
                <ul className='list-disc pl-6 space-y-2'>
                  ...
                  <li>
                    Los daños producidos por el acceso o uso del sitio web
                  </li>
                </ul>
              </section>
              ...
              <section className='mb-8'>
                ...
                <p>
                  ...
                  código fuente, marcas o logotipos) son propiedad de Daniel
                  Pereira Gesteiro o de terceros que han autorizado su uso.
                </p>
                <p className='mt-4'>
                  Queda prohibida la reproducción, distribución, comunicación
                  pública y transformación de dichos contenidos sin la
              ...
              <section className='mb-8'>
                ...
                <p>
                  El sitio web puede contener enlaces a otros sitios web. El
                  titular no se hace responsable del contenido de dichos sitios
                  ni de las condiciones de uso de los mismos.
                </p>
              </section>
